...
def check_functional_requirements():
    ...
    try:
        ...
        print("✅ Phase 3: Chatbot working")
    except Exception as e:
        print(f"❌ Phase 3: Chatbot error: {e}")
    ...
    try:
        ...
        print("✅ Phase 4: Hand Analysis working")
    except Exception as e:
        print(f"❌ Phase 4: Hand Analysis error: {e}")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print("❌ API endpoints returned non-200 status")
    except Exception as e:
